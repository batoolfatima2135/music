    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">Music</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('register') }}">Add Users</a>
                        <a class="collapse-item" href="{{ route('show') }}">Show Users</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('CreateMusicForm') }}">Add Music</a>
                        <a class="collapse-item" href="{{ route('ShowMusic') }}">Show Music</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsevideo" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('CreateVideoForm') }}">Add Video</a>
                        <a class="collapse-item" href="{{ route('ShowVideo') }}">Show Video</a>
                    </div>
                </div>
            </li>
